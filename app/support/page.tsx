        ...
        <div className="bg-white shadow-xl rounded-[2.5rem] p-10 border border-slate-100 text-right font-sans">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200">
              ...
              <a href="mailto:hello@communicateclever.com" className="text-xl font-bold text-blue-600 hover:underline break-all">
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            <p className="text-slate-300 text-[10px] font-black uppercase tracking-widest">SeniorSafe • Family Security Systems</p>
          </div>
        </div>
      </div>
    </main>
