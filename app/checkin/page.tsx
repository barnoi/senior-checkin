...
export default function Page() {
  ...
  setLoading(true);
  try {
    // שליחת הדיווח יחד עם המייל המזוהה
    const userEmail = localStorage.getItem('senior_user_email') || 'ricki.barnoi@gmail.com';
    ...
    await fetch('/api/send-all', {
      ...
      body: JSON.stringify({ 
        ...
        email: userEmail // שולחים את המייל כדי שיישמר ב-checkins
      }),
    });
    
    // שמירת הדיווח גם ב-Supabase בטבלת checkins
