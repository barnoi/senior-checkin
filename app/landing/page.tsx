              ...
              {!paid ? (
                <div className="flex flex-col gap-6">
                  ...
                  <div className="text-center">
                    <a
                      href="https://payboxapp.page.link/?link=https://web.payboxapp.com/pay/0546566336/199&apn=com.paybox.android&isi=1177062040&ibi=com.paybox.ios"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full bg-blue-500 text-white py-4 rounded-2xl font-black text-base hover:bg-blue-600 transition shadow-lg"
                    >
                      <span>💳</span>
                      <span>תשלום דרך PayBox</span>
                    </a>
                  </div>
